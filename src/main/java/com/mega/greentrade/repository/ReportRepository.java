...
import com.mega.greentrade.entity.Report;
...
public interface ReportRepository extends JpaRepository<Report, Integer> {
    ...
    @Query(value = """
            INSERT INTO report (reporterid, targetid, reportdate, reportimgurl, reportcontent, reporttitle)
            VALUES (:reporterid,
                    (SELECT userno FROM user_table_real WHERE nickname = :targetNickname),
                    NOW(), :imgurl, :content, :title)
            """, nativeQuery = true)
